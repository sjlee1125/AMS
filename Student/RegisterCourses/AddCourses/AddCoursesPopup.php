...
<script type="text/javascript">
	...
	function deleteitem(){
		...
		if(arr.length!=0){
			var datastring={ Student : Student_idx, Semester:Semester_idx, deleteitem : arr};
	...
	function show_search_name_table(){
		...
		$.ajax({
				type:"POST",
				dataType:"json",
				data : { Student : Student_idx, Semester : Semester_idx, search_string: $("#CodeName").val()},
				url:"./search_name.php",
				success: function(data){
					console.log(data);
					var text="";
	...
	function show_search_major_table(){
		...
		$.ajax({
				type:"POST",
				dataType:"json",
				data : { Student : Student_idx, Semester : Semester_idx, Major: $("#major_select option:selected").val()},
	...
	function show_upper_table(){
		...
		$.ajax({
				type:"POST",
				dataType:"json",
				data : {Student : Student_idx, Semester : Semester_idx},
				url:"./upper_table.php",
				success: function(data){
					console.log(data);
					var text="";
