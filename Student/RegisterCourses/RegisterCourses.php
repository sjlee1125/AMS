...
<script type="text/javascript">
	...
	$('#table_contents').on('click','tr',function(evt){
			...
			if($cell.index()>0&&$cell.index()<12){
			    ...
			    mapForm.action = "./Student/RegisterCourses/AddCourses/AddCoursesPopup.php";
			    ...
			    mapInput2.name = "Semester";
			    mapInput2.value = $("#semester_select option:selected").val();
	...
	function search(){
		...
		$.ajax({
				...
				dataType:"json",
				data : search_data,
				url:"./Student/RegisterCourses/search.php",
	...
	function show_default_table(){
		$.ajax({
				...
				url:"./Student/RegisterCourses/default_table.php",
				success: function(data){
					console.log(data);
					var text="";
					for(var i=0;i<data.length;i++){
