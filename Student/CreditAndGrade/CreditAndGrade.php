...
<script type="text/javascript">
	...
	$('#table_contents').on('click','tr',function(evt){
			...
			if($cell.index()>0&&$cell.index()<12){
			    ...
			    mapForm.action = "./Student/CreditAndGrade/CreditAndGradePopup/CreditAndGradePopup.php";
	...
	function search(){
		...
		$.ajax({
				...
				dataType:"json",
				data : search_data,
				url:"./Student/CreditAndGrade/search.php",
	...
	function show_default_table(){
		$.ajax({
				type:"POST",
				dataType:"json",
				url:"./Student/CreditAndGrade/default_table.php",
				success: function(data){
					console.log(data);
					var text="";
					for(var i=0;i<data.length;i++){
